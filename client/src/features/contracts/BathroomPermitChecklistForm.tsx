...
import { BathroomPermitChecklistPreview } from "./components/BathroomPermitChecklistPreview";

export function BathroomPermitChecklistForm() {
  ...
  const validateForm = () => {
    if (!formData.homeownerName || !customerEmail) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createContractMutation.mutateAsync({
        contract_type: "bathroom_permit_checklist",
    ...
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-serif font-bold text-primary" data-testid="text-page-title">
          Bathroom Remodel Permit Checklist
        </h1>
        <p className="text-muted-foreground">
          {step === 'form' && "Step 1: Fill out the checklist details"}
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="border-t pt-4">
              <h3 className="font-semibold mb-3">Homeowner Information</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                ...
                <div>
                  <Label htmlFor="homeownerAddress">Homeowner Address</Label>
                  <Input
                    id="homeownerAddress"
                    name="homeownerAddress"
                    value={formData.homeownerAddress}
                    onChange={handleInputChange}
                    data-testid="input-homeowner-address"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="border-t pt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="ctLicenseNumber">CT License Number</Label>
                  <Input
                    id="ctLicenseNumber"
                    name="ctLicenseNumber"
                    value={formData.ctLicenseNumber}
                    onChange={handleInputChange}
                    data-testid="input-ct-license"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="border-t pt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="estimatedProjectValue">Estimated Project Value</Label>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-blue-800 text-sm font-medium">Guilford, CT Permit Checklist</p>
              <p className="text-blue-700 text-sm mt-1">
                Guilford, CT permit checklist covering all required permits, application submission, inspections, and project completion requirements.
              </p>
            </div>
          ...
          <CardContent className="space-y-6">
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-4">
              <p className="text-amber-800 text-sm">
                Please read the entire checklist carefully before signing. This document is a comprehensive guide to bathroom permit requirements in Guilford, CT.
              </p>
            </div>

            <BathroomPermitChecklistPreview formData={formData} />
            ...
            <div className="flex items-center space-x-2 pt-4 border-t">
              ...
              <label htmlFor="reviewed" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                I have read and understand the complete checklist terms above
              </label>
            </div>
        ...
        <form onSubmit={handleSubmit}>
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="border-t pt-4">
                <h3 className="font-semibold mb-3">Homeowner Signature *</h3>
