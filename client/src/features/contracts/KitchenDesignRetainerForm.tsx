...
export function KitchenDesignRetainerForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createContractMutation.mutateAsync({
        contract_type: "kitchen_design_retainer",
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          {step === 'form' && "Step 1: Fill out the agreement details"}
          {step === 'preview' && "Step 2: Review the complete agreement"}
          {step === 'sign' && "Step 3: Sign the agreement"}
        </p>
      </div>
      ...
      {step === 'preview' && (
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <KitchenDesignRetainerPreview formData={formData} />
            ...
            <div className="flex items-center space-x-2 pt-4 border-t">
              ...
              <label htmlFor="reviewed" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                I have read and understand the complete agreement terms above
              </label>
            </div>
