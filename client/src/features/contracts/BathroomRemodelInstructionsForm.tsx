...
import { BathroomRemodelInstructionsPreview } from "./components/BathroomRemodelInstructionsPreview";

export function BathroomRemodelInstructionsForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createContractMutation.mutateAsync({
        contract_type: "bathroom_remodel_instructions",
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          {step === 'form' && "Step 1: Fill out the instructions details"}
          {step === 'preview' && "Step 2: Review the complete instructions"}
          {step === 'sign' && "Step 3: Sign the instructions"}
        </p>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-blue-800 text-sm font-medium">Instructions Overview</p>
              <p className="text-blue-700 text-sm mt-1">
                Internal instructions document covering site assessment, measurements, trade scheduling, design selections, and showroom appointments.
              </p>
            </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              Review Complete Instructions
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-4">
              <p className="text-amber-800 text-sm">
                Please read the entire instructions carefully before signing. This document is binding.
              </p>
            </div>

            <BathroomRemodelInstructionsPreview formData={formData} />
            ...
            <div className="flex items-center space-x-2 pt-4 border-t">
              ...
              <label htmlFor="reviewed" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                I have read and understand the complete instructions above
              </label>
            </div>
            ...
            <CardContent className="space-y-6">
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <p className="text-green-800 text-sm">
                  You have reviewed and agreed to the instructions. Please sign below to complete the document.
                </p>
              </div>
              ...
              <div className="border-t pt-4">
                ...
                <p className="text-sm text-muted-foreground mb-2">
                  Sign in the box below. Your signature will be applied to the complete instructions document you just reviewed.
                </p>
